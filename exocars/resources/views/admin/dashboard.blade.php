        ...
        <div id="content">
          ...
          <div class="container-fluid">
            ...
            <div class="listing-removal">
              <button class="btn btn-danger" onclick="openUserPopup()">
                Remove User
              </button>
            ...
            <!-- Listing Removal-->
            <div class="listing-removal">
              <button class="btn btn-danger" onclick="openListingPopup()">
                Remove Listing
              </button>
                ...
                <form>
                  <div class="mb-3">
                    <input
                      ...
                      class="form-control"
                      id="popup-form"
                      placeholder="Insert listing's id"
                    />
                    <div class="row">
                      <div class="col">
                        <button
